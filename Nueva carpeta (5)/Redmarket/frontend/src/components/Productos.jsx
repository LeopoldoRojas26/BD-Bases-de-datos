...
const Productos = () => {
  ...
  const resetForm = () => {
    setFormData({ nombre: '', descripcion: '', precio: '', id_categoria: '', codigo_barras: '' });
    setEditingId(null);
  };
      ...
      <div className="productos-grid">
        {productos.map((producto) => (
          <div key={producto.id_producto} className="producto-card">
            ...
            <p className="categoria">Categoría ID: {producto.id_categoria}</p>
            <p className="codigo">Código: {producto.codigo_barras || 'N/A'}</p>
            <div className="card-actions">
              <button className="btn-edit" onClick={() => handleEdit(producto)}>
                ✏️ Editar
              </button>
              <button className="btn-delete" onClick={() => handleDelete(producto.id_producto)}>
                🗑️ Eliminar
              </button>
            </div>
          </div>
